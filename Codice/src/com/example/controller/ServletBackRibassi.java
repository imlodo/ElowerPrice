...
/**
 * Servlet implementation class ServletBackRibassi
 */
@WebServlet("/ServletBackRibassi")
public class ServletBackRibassi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public ServletBackRibassi() {
        super();
