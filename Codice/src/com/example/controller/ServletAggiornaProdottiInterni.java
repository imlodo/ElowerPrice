...
@WebServlet("/ServletAggiornaProdottiInterni")
public class ServletAggiornaProdottiInterni extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
	
    public ServletAggiornaProdottiInterni() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{	
			...
			if(intposCorr > intsizeList)
			{
				...
				String url = "PaginaDeiProdottiInterni.jsp"; // pagina di redirect
