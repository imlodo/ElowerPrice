...
/**
 * Servlet implementation class ServletNextPiuCercati
 */
@WebServlet("/ServletNextPiuCercati")
public class ServletNextPiuCercati extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	
    public ServletNextPiuCercati() {
        super();
...
//		for(; j < nEl ; i++ , j++)
		int sizeList = listaPiuCercati.size();
