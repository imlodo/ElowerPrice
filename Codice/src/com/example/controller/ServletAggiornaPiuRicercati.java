...
@WebServlet("/ServletAggiornaPiuRicercati")
public class ServletAggiornaPiuRicercati extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
    public ServletAggiornaPiuRicercati(){
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		for(; (j < nEl) && (i < listaPiuCercati.size()); i++ , j++)
		{
